...
namespace ToMoToStudy.Controllers
{
    public class HomeController : Controller
    {
        ...
        [HttpPost]
        public ActionResult DSDapAnTL(int idsinhvien, int idtuluan, int idlop)
        {
            ViewBag.IdSinhVien = idsinhvien;
            ViewBag.IdTuLuan = idtuluan;
            ViewBag.IdLop = idlop;
            return PartialView("_PartialDapAnTL");
        }
        [HttpPost]
        public ActionResult DSDapAnTN(int idsinhvien, int idtracnghiem, int idlop)
        {
            ViewBag.IdSinhVien = idsinhvien;
            ViewBag.IdTracNghiem = idtracnghiem;
            ViewBag.IdLop = idlop;
            return PartialView("_PartialDapAnTN");
        }
        #endregion----------------------------------------------------------------------------------------------
        ...
        public ActionResult ChiTietTuLuan(int id, TuLuan data)
        {
            ...
            using (db)
            {
                ...
                tuluan.IdNguoiDung =user.IdNguoiDung;
                db.SaveChanges();
                return View(tuluan);
            }
        ...
        public ActionResult QuanLyNoiDung()
        {
        ...
        public ActionResult DSCauTuLuans(int? IdNguoiDung)
        {
            if (Session["user"] is null) return RedirectToAction("Index");
        ...
        public ActionResult DSCauTracNghiem(int? IdNguoiDung)
        {
            if (Session["user"] is null) return RedirectToAction("Index");
            ViewBag.IdNguoiDung = IdNguoiDung;
            return View();
